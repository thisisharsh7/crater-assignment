...
export default function Platform() {
    return (
        <div className="flex text-white xl:px-20 lg:px-16 md:px-10 px-6  lg:py-20 md:py-16 py-12 lg:gap-20 gap-8">
            <div className="flex flex-col flex-1 pt-5 gap-16 items-center text-center">
                ...
                <ul className="flex sm:flex-row flex-col lg:gap-12  md:gap-8 lg:text-[26px] md:text-[20px] text-[19px] gap-6 justify-around w-full items-center font-bold">
